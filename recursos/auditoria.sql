CREATE TABLE sumisiones.td_sumisiones_auditoria (
...
CREATE OR REPLACE FUNCTION sumisiones.fn_insertar_td_sumisiones_auditoria(_parametro json)
 RETURNS json
 LANGUAGE plpgsql
AS $function$
...
BEGIN
	...
	INSERT INTO sumisiones.td_sumisiones_auditoria 
	(
		es_correcto,
		accion,
	    nombre_tabla,
